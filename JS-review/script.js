...
// const seccondaryGenre = genres[1];

const [primaryGenre, seccondaryGenre, ...otherGenres] = genres;

console.log(primaryGenre, seccondaryGenre, otherGenres);
...
const pagesRange = pages > 1000 ? "over a thousand" : "les than 1000";
pagesRange;
